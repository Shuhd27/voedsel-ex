...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $productIds = [];
        $products = [
            ['category_id' => '1', 'name' => 'Aardappel', 'allergy_type' => null, 'barcode' => '8719587321239', 'expiration_date' => '2025-07-12', 'description' => 'Kruimige aardappel', 'status' => 'OpVoorraad'],
            ['category_id' => '1', 'name' => 'Aardappel', 'allergy_type' => null, 'barcode' => '8719587321239', 'expiration_date' => '2025-07-26', 'description' => 'Kruimige aardappel', 'status' => 'OpVoorraad'],
            ['category_id' => '1', 'name' => 'Ui', 'allergy_type' => null, 'barcode' => '8719437321335', 'expiration_date' => '2025-09-02', 'description' => 'Gele ui', 'status' => 'NietOpVoorraad'],
            ['category_id' => '1', 'name' => 'Appel', 'allergy_type' => null, 'barcode' => '8719486321332', 'expiration_date' => '2025-08-16', 'description' => 'Granny Smith', 'status' => 'NietLeverbaar'],
            ['category_id' => '1', 'name' => 'Appel', 'allergy_type' => null, 'barcode' => '8719486321332', 'expiration_date' => '2025-09-23', 'description' => 'Granny Smith', 'status' => 'NietLeverbaar'],
            ['category_id' => '1', 'name' => 'Banaan', 'allergy_type' => 'Banaan', 'barcode' => '8719484321336', 'expiration_date' => '2025-07-12', 'description' => 'Biologische Banaan', 'status' => 'OverHoudbaarheidsDatum'],
            ['category_id' => '1', 'name' => 'Banaan', 'allergy_type' => 'Banaan', 'barcode' => '8719484321336', 'expiration_date' => '2025-07-19', 'description' => 'Biologische Banaan', 'status' => 'OverHoudbaarheidsDatum'],
            ['category_id' => '2', 'name' => 'Kaas', 'allergy_type' => 'Lactose', 'barcode' => '8719487421338', 'expiration_date' => '2025-09-19', 'description' => 'Jonge Kaas', 'status' => 'OpVoorraad'],
            ['category_id' => '2', 'name' => 'Rosbief', 'allergy_type' => null, 'barcode' => '8719487421331', 'expiration_date' => '2025-07-23', 'description' => 'Rundvlees', 'status' => 'OpVoorraad'],
            ['category_id' => '3', 'name' => 'Melk', 'allergy_type' => 'Lactose', 'barcode' => '8719447321332', 'expiration_date' => '2025-07-23', 'description' => 'Halfvolle melk', 'status' => 'OpVoorraad'],
            ['category_id' => '3', 'name' => 'Margarine', 'allergy_type' => null, 'barcode' => '8719486321336', 'expiration_date' => '2025-08-02', 'description' => 'Plantaardige boter', 'status' => 'OpVoorraad'],
            ['category_id' => '3', 'name' => 'Ei', 'allergy_type' => 'Eier', 'barcode' => '8719487421334', 'expiration_date' => '2025-08-04', 'description' => 'Scharrelei', 'status' => 'OpVoorraad'],
            ['category_id' => '4', 'name' => 'Brood', 'allergy_type' => 'Gluten', 'barcode' => '8719487721337', 'expiration_date' => '2025-07-07', 'description' => 'Volkoren brood', 'status' => 'OpVoorraad'],
            ['category_id' => '4', 'name' => 'Gevulde Koek', 'allergy_type' => 'Amandel', 'barcode' => '8719483321333', 'expiration_date' => '2025-09-04', 'description' => 'Banketbakkers kwaliteit', 'status' => 'OpVoorraad'],
            ['category_id' => '5', 'name' => 'Fristi', 'allergy_type' => 'Lactose', 'barcode' => '8719487121331', 'expiration_date' => '2025-10-28', 'description' => 'Frisdrank', 'status' => 'NietOpVoorraad'],
            ['category_id' => '5', 'name' => 'Appelsap', 'allergy_type' => null, 'barcode' => '8719487521335', 'expiration_date' => '2025-10-19', 'description' => '100% vruchtensap', 'status' => 'OpVoorraad'],
            ['category_id' => '5', 'name' => 'Koffie', 'allergy_type' => 'Caffeïne', 'barcode' => '8719487381338', 'expiration_date' => '2025-10-23', 'description' => 'Arabica koffie', 'status' => 'OverHoudbaarheidsDatum'],
            ['category_id' => '5', 'name' => 'Thee', 'allergy_type' => 'Theïne', 'barcode' => '8719487329339', 'expiration_date' => '2025-09-02', 'description' => 'Ceylon thee', 'status' => 'OpVoorraad'],
            ['category_id' => '6', 'name' => 'Pasta', 'allergy_type' => 'Gluten', 'barcode' => '8719487321334', 'expiration_date' => '2025-12-16', 'description' => 'Macaroni', 'status' => 'NietLeverbaar'],
            ['category_id' => '6', 'name' => 'Rijst', 'allergy_type' => null, 'barcode' => '8719487331332', 'expiration_date' => '2025-12-25', 'description' => 'Basmati Rijst', 'status' => 'OpVoorraad'],
            ['category_id' => '6', 'name' => 'Knorr Nasi Mix', 'allergy_type' => null, 'barcode' => '871948735135', 'expiration_date' => '2025-12-13', 'description' => 'Nasi kruiden', 'status' => 'OpVoorraad'],
            ['category_id' => '7', 'name' => 'Tomatensoep', 'allergy_type' => null, 'barcode' => '8719487371337', 'expiration_date' => '2025-12-23', 'description' => 'Romige tomatensoep', 'status' => 'OpVoorraad'],
            ['category_id' => '7', 'name' => 'Tomatensaus', 'allergy_type' => null, 'barcode' => '8719487341334', 'expiration_date' => '2025-12-21', 'description' => 'Pizza saus', 'status' => 'NietOpVoorraad'],
            ['category_id' => '7', 'name' => 'Peterselie', 'allergy_type' => null, 'barcode' => '8719487321636', 'expiration_date' => '2025-07-31', 'description' => 'Verse kruidenpot', 'status' => 'OpVoorraad'],  // corrected 'OpVoorraaad' typo
            ['category_id' => '8', 'name' => 'Olie', 'allergy_type' => null, 'barcode' => '8719487327337', 'expiration_date' => '2025-12-27', 'description' => 'Olijfolie', 'status' => 'OpVoorraad'],
            ['category_id' => '8', 'name' => 'Mars', 'allergy_type' => null, 'barcode' => '8719487324334', 'expiration_date' => '2025-12-11', 'description' => 'Snoep', 'status' => 'OpVoorraad'],
            ['category_id' => '8', 'name' => 'Biscuit', 'allergy_type' => null, 'barcode' => '8719487311331', 'expiration_date' => '2025-08-07', 'description' => 'San Francisco biscuit', 'status' => 'OpVoorraad'],
            ['category_id' => '8', 'name' => 'Paprika Chips', 'allergy_type' => null, 'barcode' => '87194873218398', 'expiration_date' => '2025-12-22', 'description' => 'Ribbelchips paprika', 'status' => 'OpVoorraad'],
            ['category_id' => '8', 'name' => 'Chocolade reep', 'allergy_type' => 'Cacoa', 'barcode' => '8719487321533', 'expiration_date' => '2025-11-21', 'description' => 'Tony Chocolonely', 'status' => 'OpVoorraad'],
        ];
